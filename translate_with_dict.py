...
if __name__ == '__main__':
    ...
    # lines = translate('multilingual/data/test.pt-gl.pt.txt', 'test.result.pt-gl.gl.txt', d)
    # print(lines)
    src_vocab = get_vocab("cleaned-ru-be.ru")
    tgt_vocab = get_vocab("cleaned-ru-be.be")
    d = read_dict('lex.ru2be.sorted', src_vocab, tgt_vocab)
    lines = translate('multilingual/data/test.ru-be.ru.txt', 'test.result.ru-be.be.txt', d)
    print(lines)