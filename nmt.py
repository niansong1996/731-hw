...
class NMT(nn.Module):
    ...
    def __init__(self, embed_size, hidden_size, vocab, dropout_rate=0.2):
        ...
        src_weights_matrix = load_matrix("data/cc.200k.de.300.vec", self.vocab.src.word2id.keys(), self.embed_size)
        ...
        tgt_weights_matrix = load_matrix("data/cc.200k.en.300.vec", self.vocab.tgt.word2id.keys(), self.embed_size)
